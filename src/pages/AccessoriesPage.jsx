...
export const AccessoriesPage = () => {
  ...
  return <main className="py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold text-[#1a2456] mb-12">Accessories</h1>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {accessories.map((category, index) => <div key={index} className="group relative overflow-hidden rounded-lg">
